...
function onLoadPage(event)
{
    ...
    function(object)
    {
        ...
        document.getElementById("options-buttonaction").elements["type"].value = object["options-buttonactiontype"];
        document.getElementById("options-buttonaction").elements["items"].value = object["options-buttonactionitems"];
        ...
        document.getElementById("options-maxpagetime").value = object["options-maxpagetime"];
        
        document.getElementById("options-savedelaytime").value = object["options-savedelaytime"];
        ...
        document.getElementById("options-crossorigin").elements["header"].value = object["options-crossorigin"];
